...
public record EmbryonicMachineRecipe(NonNullList<Ingredient> inputs, ItemStack output
                                 , java.util.Map<ResourceLocation, Integer> weights // optional per-output weights
) implements Recipe<EmbryonicMachineRecipeInput> {
    ...
    public EmbryonicMachineRecipe(NonNullList<Ingredient> inputs, ItemStack output, java.util.Map<ResourceLocation, Integer> weights) {
        this.inputs = inputs;
        this.output = output;
    ...
    @Override
    public @NotNull ItemStack assemble(@NotNull EmbryonicMachineRecipeInput recipeInput, HolderLookup.@NotNull Provider provider) {
        return output.copy();
    }
    ...
    public static class Serializer implements RecipeSerializer<EmbryonicMachineRecipe> {
        ...
        public static final MapCodec<EmbryonicMachineRecipe> CODEC = RecordCodecBuilder.mapCodec(instance ->
                instance.group(
                        Ingredient.CODEC_NONEMPTY.listOf().fieldOf("ingredients")
                                ...
                                .forGetter(EmbryonicMachineRecipe::inputs),
                        ...
                        WEIGHTS_CODEC.optionalFieldOf("weights", java.util.Map.of())
                                .forGetter(EmbryonicMachineRecipe::weights)
                ).apply(instance, EmbryonicMachineRecipe::new)
        );
        ...
        public static final StreamCodec<RegistryFriendlyByteBuf, EmbryonicMachineRecipe> STREAM_CODEC = StreamCodec.of(
                ...
                buf -> {
                    ...
                    return new EmbryonicMachineRecipe(decodedInputs, result, weights);
                }
        );

        @Override
        public @NotNull MapCodec<EmbryonicMachineRecipe> codec() {
            return CODEC;
        }

        @Override
        public @NotNull StreamCodec<RegistryFriendlyByteBuf, EmbryonicMachineRecipe> streamCodec() {
            return STREAM_CODEC;
        }
    }
}
