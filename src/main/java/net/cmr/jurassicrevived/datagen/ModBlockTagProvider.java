...
public class ModBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(ModTags.Blocks.INCUBATED_EGGS)
                ...
                .add(ModBlocks.INCUBATED_ALLOSAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_ALVAREZSAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_ANKYLOSAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_ARAMBOURGIANIA_EGG.get())
                .add(ModBlocks.INCUBATED_CARCHARODONTOSAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_CEARADACTYLUS_EGG.get())
                .add(ModBlocks.INCUBATED_CHASMOSAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_COELOPHYSIS_EGG.get())
                .add(ModBlocks.INCUBATED_COELURUS_EGG.get())
                .add(ModBlocks.INCUBATED_CORYTHOSAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_DIMORPHODON_EGG.get())
                .add(ModBlocks.INCUBATED_DRYOSAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_GEOSTERNBERGIA_EGG.get())
                .add(ModBlocks.INCUBATED_GUIDRACO_EGG.get())
                .add(ModBlocks.INCUBATED_HADROSAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_HYPSILOPHODON_EGG.get())
                .add(ModBlocks.INCUBATED_INDORAPTOR_EGG.get())
                .add(ModBlocks.INCUBATED_INOSTRANCEVIA_EGG.get())
                .add(ModBlocks.INCUBATED_LAMBEOSAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_LUDODACTYLUS_EGG.get())
                .add(ModBlocks.INCUBATED_MAMENCHISAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_METRIACANTHOSAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_MOGANOPTERUS_EGG.get())
                .add(ModBlocks.INCUBATED_NYCTOSAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_ORNITHOLESTES_EGG.get())
                .add(ModBlocks.INCUBATED_ORNITHOMIMUS_EGG.get())
                .add(ModBlocks.INCUBATED_OVIRAPTOR_EGG.get())
                .add(ModBlocks.INCUBATED_PACHYCEPHALOSAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_PROCERATOSAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_PTERANODON_EGG.get())
                .add(ModBlocks.INCUBATED_PTERODAUSTRO_EGG.get())
                .add(ModBlocks.INCUBATED_QUETZALCOATLUS_EGG.get())
                .add(ModBlocks.INCUBATED_RAJASAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_SEGISAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_TAPEJARA_EGG.get())
                .add(ModBlocks.INCUBATED_TITANOSAURUS_EGG.get())
                .add(ModBlocks.INCUBATED_TROODON_EGG.get())
                .add(ModBlocks.INCUBATED_TROPEOGNATHUS_EGG.get())
                .add(ModBlocks.INCUBATED_TUPUXUARA_EGG.get())
                .add(ModBlocks.INCUBATED_UTAHRAPTOR_EGG.get());
