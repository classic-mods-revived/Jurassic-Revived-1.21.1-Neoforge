...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        eggLike(ModBlocks.ALLOSAURUS_EGG);
        eggLike(ModBlocks.ALVAREZSAURUS_EGG);
        eggLike(ModBlocks.ANKYLOSAURUS_EGG);
        eggLike(ModBlocks.ARAMBOURGIANIA_EGG);
        eggLike(ModBlocks.CARCHARODONTOSAURUS_EGG);
        eggLike(ModBlocks.CEARADACTYLUS_EGG);
        eggLike(ModBlocks.CHASMOSAURUS_EGG);
        eggLike(ModBlocks.COELOPHYSIS_EGG);
        eggLike(ModBlocks.COELURUS_EGG);
        eggLike(ModBlocks.CORYTHOSAURUS_EGG);
        eggLike(ModBlocks.DIMORPHODON_EGG);
        eggLike(ModBlocks.DRYOSAURUS_EGG);
        eggLike(ModBlocks.GEOSTERNBERGIA_EGG);
        eggLike(ModBlocks.GUIDRACO_EGG);
        eggLike(ModBlocks.HADROSAURUS_EGG);
        eggLike(ModBlocks.HYPSILOPHODON_EGG);
        eggLike(ModBlocks.INDORAPTOR_EGG);
        eggLike(ModBlocks.INOSTRANCEVIA_EGG);
        eggLike(ModBlocks.LAMBEOSAURUS_EGG);
        eggLike(ModBlocks.LUDODACTYLUS_EGG);
        eggLike(ModBlocks.MAMENCHISAURUS_EGG);
        eggLike(ModBlocks.METRIACANTHOSAURUS_EGG);
        eggLike(ModBlocks.MOGANOPTERUS_EGG);
        eggLike(ModBlocks.NYCTOSAURUS_EGG);
        eggLike(ModBlocks.ORNITHOLESTES_EGG);
        eggLike(ModBlocks.ORNITHOMIMUS_EGG);
        eggLike(ModBlocks.OVIRAPTOR_EGG);
        eggLike(ModBlocks.PACHYCEPHALOSAURUS_EGG);
        eggLike(ModBlocks.PROCERATOSAURUS_EGG);
        eggLike(ModBlocks.PTERANODON_EGG);
        eggLike(ModBlocks.PTERODAUSTRO_EGG);
        eggLike(ModBlocks.QUETZALCOATLUS_EGG);
        eggLike(ModBlocks.RAJASAURUS_EGG);
        eggLike(ModBlocks.SEGISAURUS_EGG);
        eggLike(ModBlocks.TAPEJARA_EGG);
        eggLike(ModBlocks.TITANOSAURUS_EGG);
        eggLike(ModBlocks.TROODON_EGG);
        eggLike(ModBlocks.TROPEOGNATHUS_EGG);
        eggLike(ModBlocks.TUPUXUARA_EGG);
        eggLike(ModBlocks.UTAHRAPTOR_EGG);
        eggLike(ModBlocks.ZHENYUANOPTERUS_EGG);
        ...
        eggLike(ModBlocks.INCUBATED_ALLOSAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_ALVAREZSAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_ANKYLOSAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_ARAMBOURGIANIA_EGG);
        eggLike(ModBlocks.INCUBATED_CARCHARODONTOSAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_CEARADACTYLUS_EGG);
        eggLike(ModBlocks.INCUBATED_CHASMOSAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_COELOPHYSIS_EGG);
        eggLike(ModBlocks.INCUBATED_COELURUS_EGG);
        eggLike(ModBlocks.INCUBATED_CORYTHOSAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_DIMORPHODON_EGG);
        eggLike(ModBlocks.INCUBATED_DRYOSAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_GEOSTERNBERGIA_EGG);
        eggLike(ModBlocks.INCUBATED_GUIDRACO_EGG);
        eggLike(ModBlocks.INCUBATED_HADROSAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_HYPSILOPHODON_EGG);
        eggLike(ModBlocks.INCUBATED_INDORAPTOR_EGG);
        eggLike(ModBlocks.INCUBATED_INOSTRANCEVIA_EGG);
        eggLike(ModBlocks.INCUBATED_LAMBEOSAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_LUDODACTYLUS_EGG);
        eggLike(ModBlocks.INCUBATED_MAMENCHISAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_METRIACANTHOSAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_MOGANOPTERUS_EGG);
        eggLike(ModBlocks.INCUBATED_NYCTOSAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_ORNITHOLESTES_EGG);
        eggLike(ModBlocks.INCUBATED_ORNITHOMIMUS_EGG);
        eggLike(ModBlocks.INCUBATED_OVIRAPTOR_EGG);
        eggLike(ModBlocks.INCUBATED_PACHYCEPHALOSAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_PROCERATOSAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_PTERANODON_EGG);
        eggLike(ModBlocks.INCUBATED_PTERODAUSTRO_EGG);
        eggLike(ModBlocks.INCUBATED_QUETZALCOATLUS_EGG);
        eggLike(ModBlocks.INCUBATED_RAJASAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_SEGISAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_TAPEJARA_EGG);
        eggLike(ModBlocks.INCUBATED_TITANOSAURUS_EGG);
        eggLike(ModBlocks.INCUBATED_TROODON_EGG);
        eggLike(ModBlocks.INCUBATED_TROPEOGNATHUS_EGG);
        eggLike(ModBlocks.INCUBATED_TUPUXUARA_EGG);
        eggLike(ModBlocks.INCUBATED_UTAHRAPTOR_EGG);
        eggLike(ModBlocks.INCUBATED_ZHENYUANOPTERUS_EGG);
