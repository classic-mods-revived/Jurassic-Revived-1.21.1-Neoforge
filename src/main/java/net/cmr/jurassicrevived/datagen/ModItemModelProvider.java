...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        withExistingParent(ModItems.ALLOSAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.ALVAREZSAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.ANKYLOSAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.CARCHARODONTOSAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.CHASMOSAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.COELOPHYSIS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.COELURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.CORYTHOSAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.DRYOSAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.HADROSAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.HYPSILOPHODON_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.INDORAPTOR_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.INOSTRANCEVIA_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.LAMBEOSAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.MAMENCHISAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.METRIACANTHOSAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.ORNITHOLESTES_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.ORNITHOMIMUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.OVIRAPTOR_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.PACHYCEPHALOSAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.PROCERATOSAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.RAJASAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.SEGISAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.TITANOSAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.TROODON_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        ...
        basicItem(ModItems.ALLOSAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.ALVAREZSAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.ANKYLOSAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.ARAMBOURGIANIA_SKULL_FOSSIL.get());
        basicItem(ModItems.CARCHARODONTOSAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.CEARADACTYLUS_SKULL_FOSSIL.get());
        basicItem(ModItems.CHASMOSAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.COELOPHYSIS_SKULL_FOSSIL.get());
        basicItem(ModItems.COELURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.CORYTHOSAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.DIMORPHODON_SKULL_FOSSIL.get());
        basicItem(ModItems.DRYOSAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.GEOSTERNBERGIA_SKULL_FOSSIL.get());
        basicItem(ModItems.GUIDRACO_SKULL_FOSSIL.get());
        basicItem(ModItems.HADROSAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.HYPSILOPHODON_SKULL_FOSSIL.get());
        basicItem(ModItems.INOSTRANCEVIA_SKULL_FOSSIL.get());
        basicItem(ModItems.LAMBEOSAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.LUDODACTYLUS_SKULL_FOSSIL.get());
        basicItem(ModItems.MAMENCHISAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.METRIACANTHOSAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.MOGANOPTERUS_SKULL_FOSSIL.get());
        basicItem(ModItems.NYCTOSAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.ORNITHOLESTES_SKULL_FOSSIL.get());
        basicItem(ModItems.ORNITHOMIMUS_SKULL_FOSSIL.get());
        basicItem(ModItems.OVIRAPTOR_SKULL_FOSSIL.get());
        basicItem(ModItems.PACHYCEPHALOSAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.PROCERATOSAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.PTERANODON_SKULL_FOSSIL.get());
        basicItem(ModItems.PTERODAUSTRO_SKULL_FOSSIL.get());
        basicItem(ModItems.QUETZALCOATLUS_SKULL_FOSSIL.get());
        basicItem(ModItems.RAJASAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.SEGISAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.TAPEJARA_SKULL_FOSSIL.get());
        basicItem(ModItems.TITANOSAURUS_SKULL_FOSSIL.get());
        basicItem(ModItems.TROODON_SKULL_FOSSIL.get());
        basicItem(ModItems.TROPEOGNATHUS_SKULL_FOSSIL.get());
        basicItem(ModItems.TUPUXUARA_SKULL_FOSSIL.get());
        basicItem(ModItems.UTAHRAPTOR_SKULL_FOSSIL.get());
        basicItem(ModItems.ZHENYUANOPTERUS_SKULL_FOSSIL.get());
        ...
        basicItem(ModItems.FRESH_ALLOSAURUS_SKULL.get());
        basicItem(ModItems.FRESH_ALVAREZSAURUS_SKULL.get());
        basicItem(ModItems.FRESH_ANKYLOSAURUS_SKULL.get());
        basicItem(ModItems.FRESH_ARAMBOURGIANIA_SKULL.get());
        basicItem(ModItems.FRESH_CARCHARODONTOSAURUS_SKULL.get());
        basicItem(ModItems.FRESH_CEARADACTYLUS_SKULL.get());
        basicItem(ModItems.FRESH_CHASMOSAURUS_SKULL.get());
        basicItem(ModItems.FRESH_COELOPHYSIS_SKULL.get());
        basicItem(ModItems.FRESH_COELURUS_SKULL.get());
        basicItem(ModItems.FRESH_CORYTHOSAURUS_SKULL.get());
        basicItem(ModItems.FRESH_DIMORPHODON_SKULL.get());
        basicItem(ModItems.FRESH_DRYOSAURUS_SKULL.get());
        basicItem(ModItems.FRESH_GEOSTERNBERGIA_SKULL.get());
        basicItem(ModItems.FRESH_GUIDRACO_SKULL.get());
        basicItem(ModItems.FRESH_HADROSAURUS_SKULL.get());
        basicItem(ModItems.FRESH_HYPSILOPHODON_SKULL.get());
        basicItem(ModItems.FRESH_INDORAPTOR_SKULL.get());
        basicItem(ModItems.FRESH_INOSTRANCEVIA_SKULL.get());
        basicItem(ModItems.FRESH_LAMBEOSAURUS_SKULL.get());
        basicItem(ModItems.FRESH_LUDODACTYLUS_SKULL.get());
        basicItem(ModItems.FRESH_MAMENCHISAURUS_SKULL.get());
        basicItem(ModItems.FRESH_METRIACANTHOSAURUS_SKULL.get());
        basicItem(ModItems.FRESH_MOGANOPTERUS_SKULL.get());
        basicItem(ModItems.FRESH_NYCTOSAURUS_SKULL.get());
        basicItem(ModItems.FRESH_ORNITHOLESTES_SKULL.get());
        basicItem(ModItems.FRESH_ORNITHOMIMUS_SKULL.get());
        basicItem(ModItems.FRESH_OVIRAPTOR_SKULL.get());
        basicItem(ModItems.FRESH_PACHYCEPHALOSAURUS_SKULL.get());
        basicItem(ModItems.FRESH_PROCERATOSAURUS_SKULL.get());
        basicItem(ModItems.FRESH_PTERANODON_SKULL.get());
        basicItem(ModItems.FRESH_PTERODAUSTRO_SKULL.get());
        basicItem(ModItems.FRESH_QUETZALCOATLUS_SKULL.get());
        basicItem(ModItems.FRESH_RAJASAURUS_SKULL.get());
        basicItem(ModItems.FRESH_SEGISAURUS_SKULL.get());
        basicItem(ModItems.FRESH_TAPEJARA_SKULL.get());
        basicItem(ModItems.FRESH_TITANOSAURUS_SKULL.get());
        basicItem(ModItems.FRESH_TROODON_SKULL.get());
        basicItem(ModItems.FRESH_TROPEOGNATHUS_SKULL.get());
        basicItem(ModItems.FRESH_TUPUXUARA_SKULL.get());
        basicItem(ModItems.FRESH_UTAHRAPTOR_SKULL.get());
        basicItem(ModItems.FRESH_ZHENYUANOPTERUS_SKULL.get());
        ...
        basicItem(ModItems.ALLOSAURUS_TISSUE.get());
        basicItem(ModItems.ALVAREZSAURUS_TISSUE.get());
        basicItem(ModItems.ANKYLOSAURUS_TISSUE.get());
        basicItem(ModItems.ARAMBOURGIANIA_TISSUE.get());
        basicItem(ModItems.CARCHARODONTOSAURUS_TISSUE.get());
        basicItem(ModItems.CEARADACTYLUS_TISSUE.get());
        basicItem(ModItems.CHASMOSAURUS_TISSUE.get());
        basicItem(ModItems.COELOPHYSIS_TISSUE.get());
        basicItem(ModItems.COELURUS_TISSUE.get());
        basicItem(ModItems.CORYTHOSAURUS_TISSUE.get());
        basicItem(ModItems.DIMORPHODON_TISSUE.get());
        basicItem(ModItems.DRYOSAURUS_TISSUE.get());
        basicItem(ModItems.GEOSTERNBERGIA_TISSUE.get());
        basicItem(ModItems.GUIDRACO_TISSUE.get());
        basicItem(ModItems.HADROSAURUS_TISSUE.get());
        basicItem(ModItems.HYPSILOPHODON_TISSUE.get());
        basicItem(ModItems.INDORAPTOR_TISSUE.get());
        basicItem(ModItems.INOSTRANCEVIA_TISSUE.get());
        basicItem(ModItems.LAMBEOSAURUS_TISSUE.get());
        basicItem(ModItems.LUDODACTYLUS_TISSUE.get());
        basicItem(ModItems.MAMENCHISAURUS_TISSUE.get());
        basicItem(ModItems.METRIACANTHOSAURUS_TISSUE.get());
        basicItem(ModItems.MOGANOPTERUS_TISSUE.get());
        basicItem(ModItems.NYCTOSAURUS_TISSUE.get());
        basicItem(ModItems.ORNITHOLESTES_TISSUE.get());
        basicItem(ModItems.ORNITHOMIMUS_TISSUE.get());
        basicItem(ModItems.OVIRAPTOR_TISSUE.get());
        basicItem(ModItems.PACHYCEPHALOSAURUS_TISSUE.get());
        basicItem(ModItems.PROCERATOSAURUS_TISSUE.get());
        basicItem(ModItems.PTERANODON_TISSUE.get());
        basicItem(ModItems.PTERODAUSTRO_TISSUE.get());
        basicItem(ModItems.QUETZALCOATLUS_TISSUE.get());
        basicItem(ModItems.RAJASAURUS_TISSUE.get());
        basicItem(ModItems.SEGISAURUS_TISSUE.get());
        basicItem(ModItems.TAPEJARA_TISSUE.get());
        basicItem(ModItems.TITANOSAURUS_TISSUE.get());
        basicItem(ModItems.TROODON_TISSUE.get());
        basicItem(ModItems.TROPEOGNATHUS_TISSUE.get());
        basicItem(ModItems.TUPUXUARA_TISSUE.get());
        basicItem(ModItems.UTAHRAPTOR_TISSUE.get());
        basicItem(ModItems.ZHENYUANOPTERUS_TISSUE.get());
        ...
        basicItem(ModItems.ALLOSAURUS_DNA.get());
        basicItem(ModItems.ALVAREZSAURUS_DNA.get());
        basicItem(ModItems.ANKYLOSAURUS_DNA.get());
        basicItem(ModItems.ARAMBOURGIANIA_DNA.get());
        basicItem(ModItems.CARCHARODONTOSAURUS_DNA.get());
        basicItem(ModItems.CEARADACTYLUS_DNA.get());
        basicItem(ModItems.CHASMOSAURUS_DNA.get());
        basicItem(ModItems.COELOPHYSIS_DNA.get());
        basicItem(ModItems.COELURUS_DNA.get());
        basicItem(ModItems.CORYTHOSAURUS_DNA.get());
        basicItem(ModItems.DIMORPHODON_DNA.get());
        basicItem(ModItems.DRYOSAURUS_DNA.get());
        basicItem(ModItems.GEOSTERNBERGIA_DNA.get());
        basicItem(ModItems.GUIDRACO_DNA.get());
        basicItem(ModItems.HADROSAURUS_DNA.get());
        basicItem(ModItems.HYPSILOPHODON_DNA.get());
        basicItem(ModItems.INDORAPTOR_DNA.get());
        basicItem(ModItems.INOSTRANCEVIA_DNA.get());
        basicItem(ModItems.LAMBEOSAURUS_DNA.get());
        basicItem(ModItems.LUDODACTYLUS_DNA.get());
        basicItem(ModItems.MAMENCHISAURUS_DNA.get());
        basicItem(ModItems.METRIACANTHOSAURUS_DNA.get());
        basicItem(ModItems.MOGANOPTERUS_DNA.get());
        basicItem(ModItems.NYCTOSAURUS_DNA.get());
        basicItem(ModItems.ORNITHOLESTES_DNA.get());
        basicItem(ModItems.ORNITHOMIMUS_DNA.get());
        basicItem(ModItems.OVIRAPTOR_DNA.get());
        basicItem(ModItems.PACHYCEPHALOSAURUS_DNA.get());
        basicItem(ModItems.PROCERATOSAURUS_DNA.get());
        basicItem(ModItems.PTERANODON_DNA.get());
        basicItem(ModItems.PTERODAUSTRO_DNA.get());
        basicItem(ModItems.QUETZALCOATLUS_DNA.get());
        basicItem(ModItems.RAJASAURUS_DNA.get());
        basicItem(ModItems.SEGISAURUS_DNA.get());
        basicItem(ModItems.TAPEJARA_DNA.get());
        basicItem(ModItems.TITANOSAURUS_DNA.get());
        basicItem(ModItems.TROODON_DNA.get());
        basicItem(ModItems.TROPEOGNATHUS_DNA.get());
        basicItem(ModItems.TUPUXUARA_DNA.get());
        basicItem(ModItems.UTAHRAPTOR_DNA.get());
        basicItem(ModItems.ZHENYUANOPTERUS_DNA.get());
        ...
        basicItem(ModItems.ALLOSAURUS_SYRINGE.get());
        basicItem(ModItems.ALVAREZSAURUS_SYRINGE.get());
        basicItem(ModItems.ANKYLOSAURUS_SYRINGE.get());
        basicItem(ModItems.ARAMBOURGIANIA_SYRINGE.get());
        basicItem(ModItems.CARCHARODONTOSAURUS_SYRINGE.get());
        basicItem(ModItems.CEARADACTYLUS_SYRINGE.get());
        basicItem(ModItems.CHASMOSAURUS_SYRINGE.get());
        basicItem(ModItems.COELOPHYSIS_SYRINGE.get());
        basicItem(ModItems.COELURUS_SYRINGE.get());
        basicItem(ModItems.CORYTHOSAURUS_SYRINGE.get());
        basicItem(ModItems.DIMORPHODON_SYRINGE.get());
        basicItem(ModItems.DRYOSAURUS_SYRINGE.get());
        basicItem(ModItems.GEOSTERNBERGIA_SYRINGE.get());
        basicItem(ModItems.GUIDRACO_SYRINGE.get());
        basicItem(ModItems.HADROSAURUS_SYRINGE.get());
        basicItem(ModItems.HYPSILOPHODON_SYRINGE.get());
        basicItem(ModItems.INDORAPTOR_SYRINGE.get());
        basicItem(ModItems.INOSTRANCEVIA_SYRINGE.get());
        basicItem(ModItems.LAMBEOSAURUS_SYRINGE.get());
        basicItem(ModItems.LUDODACTYLUS_SYRINGE.get());
        basicItem(ModItems.MAMENCHISAURUS_SYRINGE.get());
        basicItem(ModItems.METRIACANTHOSAURUS_SYRINGE.get());
        basicItem(ModItems.MOGANOPTERUS_SYRINGE.get());
        basicItem(ModItems.NYCTOSAURUS_SYRINGE.get());
        basicItem(ModItems.ORNITHOLESTES_SYRINGE.get());
        basicItem(ModItems.ORNITHOMIMUS_SYRINGE.get());
        basicItem(ModItems.OVIRAPTOR_SYRINGE.get());
        basicItem(ModItems.PACHYCEPHALOSAURUS_SYRINGE.get());
        basicItem(ModItems.PROCERATOSAURUS_SYRINGE.get());
        basicItem(ModItems.PTERANODON_SYRINGE.get());
        basicItem(ModItems.PTERODAUSTRO_SYRINGE.get());
        basicItem(ModItems.QUETZALCOATLUS_SYRINGE.get());
        basicItem(ModItems.RAJASAURUS_SYRINGE.get());
        basicItem(ModItems.SEGISAURUS_SYRINGE.get());
        basicItem(ModItems.TAPEJARA_SYRINGE.get());
        basicItem(ModItems.TITANOSAURUS_SYRINGE.get());
        basicItem(ModItems.TROODON_SYRINGE.get());
        basicItem(ModItems.TROPEOGNATHUS_SYRINGE.get());
        basicItem(ModItems.TUPUXUARA_SYRINGE.get());
        basicItem(ModItems.UTAHRAPTOR_SYRINGE.get());
        basicItem(ModItems.ZHENYUANOPTERUS_SYRINGE.get());
        ...
        simpleBlockItemBlockTexture(ModBlocks.ALLOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.ALVAREZSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.ANKYLOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.ARAMBOURGIANIA_EGG);
        simpleBlockItemBlockTexture(ModBlocks.CARCHARODONTOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.CEARADACTYLUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.CHASMOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.COELOPHYSIS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.COELURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.CORYTHOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.DIMORPHODON_EGG);
        simpleBlockItemBlockTexture(ModBlocks.DRYOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.GEOSTERNBERGIA_EGG);
        simpleBlockItemBlockTexture(ModBlocks.GUIDRACO_EGG);
        simpleBlockItemBlockTexture(ModBlocks.HADROSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.HYPSILOPHODON_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INDORAPTOR_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INOSTRANCEVIA_EGG);
        simpleBlockItemBlockTexture(ModBlocks.LAMBEOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.LUDODACTYLUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.MAMENCHISAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.METRIACANTHOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.MOGANOPTERUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.NYCTOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.ORNITHOLESTES_EGG);
        simpleBlockItemBlockTexture(ModBlocks.ORNITHOMIMUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.OVIRAPTOR_EGG);
        simpleBlockItemBlockTexture(ModBlocks.PACHYCEPHALOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.PROCERATOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.PTERANODON_EGG);
        simpleBlockItemBlockTexture(ModBlocks.PTERODAUSTRO_EGG);
        simpleBlockItemBlockTexture(ModBlocks.QUETZALCOATLUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.RAJASAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.SEGISAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.TAPEJARA_EGG);
        simpleBlockItemBlockTexture(ModBlocks.TITANOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.TROODON_EGG);
        simpleBlockItemBlockTexture(ModBlocks.TROPEOGNATHUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.TUPUXUARA_EGG);
        simpleBlockItemBlockTexture(ModBlocks.UTAHRAPTOR_EGG);
        simpleBlockItemBlockTexture(ModBlocks.ZHENYUANOPTERUS_EGG);
        ...
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_ALLOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_ALVAREZSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_ANKYLOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_ARAMBOURGIANIA_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_CARCHARODONTOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_CEARADACTYLUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_CHASMOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_COELOPHYSIS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_COELURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_CORYTHOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_DIMORPHODON_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_DRYOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_GEOSTERNBERGIA_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_GUIDRACO_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_HADROSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_HYPSILOPHODON_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_INDORAPTOR_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_INOSTRANCEVIA_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_LAMBEOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_LUDODACTYLUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_MAMENCHISAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_METRIACANTHOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_MOGANOPTERUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_NYCTOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_ORNITHOLESTES_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_ORNITHOMIMUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_OVIRAPTOR_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_PACHYCEPHALOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_PROCERATOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_PTERANODON_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_PTERODAUSTRO_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_QUETZALCOATLUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_RAJASAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_SEGISAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_TAPEJARA_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_TITANOSAURUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_TROODON_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_TROPEOGNATHUS_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_TUPUXUARA_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_UTAHRAPTOR_EGG);
        simpleBlockItemBlockTexture(ModBlocks.INCUBATED_ZHENYUANOPTERUS_EGG);
