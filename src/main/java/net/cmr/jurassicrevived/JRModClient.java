...
public class JRModClient {
    ...
    static void onClientSetup(FMLClientSetupEvent event) {
        ...
        EntityRenderers.register(ModEntities.ARAMBOURGIANIA.get(), ArambourgianiaRenderer::new);
        EntityRenderers.register(ModEntities.CEARADACTYLUS.get(), CearadactylusRenderer::new);
        EntityRenderers.register(ModEntities.DIMORPHODON.get(), DimorphodonRenderer::new);
        EntityRenderers.register(ModEntities.GEOSTERNBERGIA.get(), GeosternbergiaRenderer::new);
        EntityRenderers.register(ModEntities.GUIDRACO.get(), GuidracoRenderer::new);
        EntityRenderers.register(ModEntities.LUDODACTYLUS.get(), LudodactylusRenderer::new);
        EntityRenderers.register(ModEntities.MOGANOPTERUS.get(), MoganopterusRenderer::new);
        EntityRenderers.register(ModEntities.NYCTOSAURUS.get(), NyctosaurusRenderer::new);
        EntityRenderers.register(ModEntities.PTERANODON.get(), PteranodonRenderer::new);
        EntityRenderers.register(ModEntities.PTERODAUSTRO.get(), PterodaustroRenderer::new);
        EntityRenderers.register(ModEntities.QUETZALCOATLUS.get(), QuetzalcoatlusRenderer::new);
        EntityRenderers.register(ModEntities.TAPEJARA.get(), TapejaraRenderer::new);
        EntityRenderers.register(ModEntities.TROPEOGNATHUS.get(), TropeognathusRenderer::new);
        EntityRenderers.register(ModEntities.TUPUXUARA.get(), TupuxuaraRenderer::new);
        EntityRenderers.register(ModEntities.ZHENYUANOPTERUS.get(), ZhenyuanopterusRenderer::new);
