    ...
    public static final Supplier<CreativeModeTab> JR_DNA_TAB =
            CREATIVE_MODE_TABS.register("jurassicrevived_dna_tab", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        // Eggs (alphabetical)
                        pOutput.accept(ModItems.ALBERTOSAURUS_EGG);
                        pOutput.accept(ModItems.APATOSAURUS_EGG);
                        pOutput.accept(ModItems.BARYONYX_EGG);
                        pOutput.accept(ModItems.BRACHIOSAURUS_EGG);
                        pOutput.accept(ModItems.CARNOTAURUS_EGG);
                        pOutput.accept(ModItems.CERATOSAURUS_EGG);
                        pOutput.accept(ModItems.COMPSOGNATHUS_EGG);
                        pOutput.accept(ModItems.CONCAVENATOR_EGG);
                        pOutput.accept(ModItems.DEINONYCHUS_EGG);
                        pOutput.accept(ModItems.DILOPHOSAURUS_EGG);
                        pOutput.accept(ModItems.DIPLODOCUS_EGG);
                        pOutput.accept(ModItems.DISTORTUS_REX_EGG);
                        pOutput.accept(ModItems.EDMONTOSAURUS_EGG);
                        pOutput.accept(ModItems.GALLIMIMUS_EGG);
                        pOutput.accept(ModItems.GIGANOTOSAURUS_EGG);
                        pOutput.accept(ModItems.GUANLONG_EGG);
                        pOutput.accept(ModItems.HERRERASAURUS_EGG);
                        pOutput.accept(ModItems.INDOMINUS_REX_EGG);
                        pOutput.accept(ModItems.MAJUNGASAURUS_EGG);
                        pOutput.accept(ModItems.OURANOSAURUS_EGG);
                        pOutput.accept(ModItems.PARASAUROLOPHUS_EGG);
                        pOutput.accept(ModItems.PROCOMPSOGNATHUS_EGG);
                        pOutput.accept(ModItems.PROTOCERATOPS_EGG);
                        pOutput.accept(ModItems.RUGOPS_EGG);
                        pOutput.accept(ModItems.SHANTUNGOSAURUS_EGG);
                        pOutput.accept(ModItems.SPINOSAURUS_EGG);
                        pOutput.accept(ModItems.STEGOSAURUS_EGG);
                        pOutput.accept(ModItems.STYRACOSAURUS_EGG);
                        pOutput.accept(ModItems.THERIZINOSAURUS_EGG);
