...
public class OviraptorModel extends GeoModel<OviraptorEntity> {
    ...
    private static final Map<OviraptorVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(OviraptorVariant.class), map -> {
                map.put(OviraptorVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/oviraptor.png"));
                map.put(OviraptorVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/oviraptor_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(OviraptorEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/oviraptor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(OviraptorEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(OviraptorEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/oviraptor.animation.json");
    }

    @Override
    public void setCustomAnimations(OviraptorEntity entity, long id, AnimationState<OviraptorEntity> state) {
