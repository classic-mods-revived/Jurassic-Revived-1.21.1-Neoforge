...
public class AlvarezsaurusModel extends GeoModel<AlvarezsaurusEntity> {
    ...
    private static final Map<AlvarezsaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(AlvarezsaurusVariant.class), map -> {
                map.put(AlvarezsaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/alvarezsaurus.png"));
                map.put(AlvarezsaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/alvarezsaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(AlvarezsaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/alvarezsaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(AlvarezsaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/alvarezsaurus.animation.json");
    }
