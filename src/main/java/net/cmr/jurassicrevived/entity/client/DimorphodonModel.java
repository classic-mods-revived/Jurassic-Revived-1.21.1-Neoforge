...
public class DimorphodonModel extends GeoModel<DimorphodonEntity> {
    ...
    private static final Map<DimorphodonVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(DimorphodonVariant.class), map -> {
                map.put(DimorphodonVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/dimorphodon.png"));
                map.put(DimorphodonVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/dimorphodon_female.png"));
            });
    ...
    public ResourceLocation getModelResource(DimorphodonEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/dimorphodon.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(DimorphodonEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/dimorphodon.animation.json");
    }
