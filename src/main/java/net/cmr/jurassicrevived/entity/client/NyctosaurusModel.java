...
import net.cmr.jurassicrevived.entity.custom.NyctosaurusEntity;
...
public class NyctosaurusModel extends GeoModel<NyctosaurusEntity> {
    ...
    private static final Map<NyctosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(NyctosaurusVariant.class), map -> {
                map.put(NyctosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/nyctosaurus.png"));
                map.put(NyctosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/nyctosaurus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(NyctosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/nyctosaurus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(NyctosaurusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(NyctosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/nyctosaurus.animation.json");
    }

    @Override
    public void setCustomAnimations(NyctosaurusEntity entity, long id, AnimationState<NyctosaurusEntity> state) {
