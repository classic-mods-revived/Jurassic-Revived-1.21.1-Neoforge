...
public class TupuxuaraModel extends GeoModel<TupuxuaraEntity> {

    private static final Map<TupuxuaraVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(TupuxuaraVariant.class), map -> {
                map.put(TupuxuaraVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/tupuxuara.png"));
                map.put(TupuxuaraVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/tupuxuara_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(TupuxuaraEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/tupuxuara.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(TupuxuaraEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(TupuxuaraEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/tupuxuara.animation.json");
    }

    @Override
    public void setCustomAnimations(TupuxuaraEntity entity, long id, AnimationState<TupuxuaraEntity> state) {
