...
public class MetriacanthosaurusModel extends GeoModel<MetriacanthosaurusEntity> {
    ...
    private static final Map<MetriacanthosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(MetriacanthosaurusVariant.class), map -> {
                map.put(MetriacanthosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/metriacanthosaurus.png"));
                map.put(MetriacanthosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/metriacanthosaurus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(MetriacanthosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/metriacanthosaurus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(MetriacanthosaurusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(MetriacanthosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/metriacanthosaurus.animation.json");
    }

    @Override
    public void setCustomAnimations(MetriacanthosaurusEntity entity, long id, AnimationState<MetriacanthosaurusEntity> state) {
