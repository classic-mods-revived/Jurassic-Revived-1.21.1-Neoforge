...
import net.cmr.jurassicrevived.entity.custom.QuetzalcoatlusEntity;
...
public class QuetzalcoatlusModel extends GeoModel<QuetzalcoatlusEntity> {
    ...
    private static final Map<QuetzalcoatlusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(QuetzalcoatlusVariant.class), map -> {
                map.put(QuetzalcoatlusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/quetzalcoatlus.png"));
                map.put(QuetzalcoatlusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/quetzalcoatlus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(QuetzalcoatlusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/quetzalcoatlus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(QuetzalcoatlusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/quetzalcoatlus.animation.json");
    }

    @Override
    public void setCustomAnimations(QuetzalcoatlusEntity entity, long id, AnimationState<QuetzalcoatlusEntity> state) {
