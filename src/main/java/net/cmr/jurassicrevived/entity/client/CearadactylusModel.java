...
public class CearadactylusModel extends GeoModel<CearadactylusEntity> {
    ...
    private static final Map<CearadactylusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(CearadactylusVariant.class), map -> {
                map.put(CearadactylusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/cearadactylus.png"));
                map.put(CearadactylusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/cearadactylus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(CearadactylusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/cearadactylus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(CearadactylusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/cearadactylus.animation.json");
    }
