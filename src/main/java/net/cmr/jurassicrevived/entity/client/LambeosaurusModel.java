...
public class LambeosaurusModel extends GeoModel<LambeosaurusEntity> {
    ...
    private static final Map<LambeosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(LambeosaurusVariant.class), map -> {
                map.put(LambeosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/lambeosaurus.png"));
                map.put(LambeosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/lambeosaurus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(LambeosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/lambeosaurus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(LambeosaurusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(LambeosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/lambeosaurus.animation.json");
    }

    @Override
    public void setCustomAnimations(LambeosaurusEntity entity, long id, AnimationState<LambeosaurusEntity> state) {
