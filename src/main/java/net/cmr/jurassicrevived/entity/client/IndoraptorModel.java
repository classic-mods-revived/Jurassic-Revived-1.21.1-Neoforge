...
public class IndoraptorModel extends GeoModel<IndoraptorEntity> {
    ...
    private static final Map<IndoraptorVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(IndoraptorVariant.class), map -> {
                map.put(IndoraptorVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/indoraptor.png"));
                map.put(IndoraptorVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/indoraptor_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(IndoraptorEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/indoraptor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(IndoraptorEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(IndoraptorEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/indoraptor.animation.json");
    }

    @Override
    public void setCustomAnimations(IndoraptorEntity entity, long id, AnimationState<IndoraptorEntity> state) {
        super.setCustomAnimations(entity, id, state);

        String[] tailBones = { "TailMain", "Tail1", "Tail2", "Tail3", "Tail4", "Tail5", "Tail6", "Tail7" };
