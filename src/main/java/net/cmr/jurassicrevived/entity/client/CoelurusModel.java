...
public class CoelurusModel extends GeoModel<CoelurusEntity> {
    ...
    private static final Map<CoelurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(CoelurusVariant.class), map -> {
                map.put(CoelurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/coelurus.png"));
                map.put(CoelurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/coelurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(CoelurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/coelurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(CoelurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/coelurus.animation.json");
    }
