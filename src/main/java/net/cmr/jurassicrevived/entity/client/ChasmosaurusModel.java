...
public class ChasmosaurusModel extends GeoModel<ChasmosaurusEntity> {
    ...
    private static final Map<ChasmosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(ChasmosaurusVariant.class), map -> {
                map.put(ChasmosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/chasmosaurus.png"));
                map.put(ChasmosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/chasmosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(ChasmosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/chasmosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(ChasmosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/chasmosaurus.animation.json");
    }
