...
public class TropeognathusModel extends GeoModel<TropeognathusEntity> {

    private static final Map<TropeognathusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(TropeognathusVariant.class), map -> {
                map.put(TropeognathusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/tropeognathus.png"));
                map.put(TropeognathusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/tropeognathus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(TropeognathusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/tropeognathus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(TropeognathusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(TropeognathusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/tropeognathus.animation.json");
    }

    @Override
    public void setCustomAnimations(TropeognathusEntity entity, long id, AnimationState<TropeognathusEntity> state) {
