...
public class ProceratosaurusModel extends GeoModel<ProceratosaurusEntity> {

    private static final Map<ProceratosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(ProceratosaurusVariant.class), map -> {
                map.put(ProceratosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/proceratosaurus.png"));
                map.put(ProceratosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/proceratosaurus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(ProceratosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/proceratosaurus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(ProceratosaurusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(ProceratosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/proceratosaurus.animation.json");
    }

    @Override
    public void setCustomAnimations(ProceratosaurusEntity entity, long id, AnimationState<ProceratosaurusEntity> state) {
