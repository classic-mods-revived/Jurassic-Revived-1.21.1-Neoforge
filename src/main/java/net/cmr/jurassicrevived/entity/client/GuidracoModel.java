...
import net.cmr.jurassicrevived.entity.custom.GuidracoEntity;
...
public class GuidracoModel extends GeoModel<GuidracoEntity> {

    private static final Map<GuidracoVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(GuidracoVariant.class), map -> {
                map.put(GuidracoVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/guidraco.png"));
                map.put(GuidracoVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/guidraco_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(GuidracoEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/guidraco.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(GuidracoEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(GuidracoEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/guidraco.animation.json");
    }

    @Override
    public void setCustomAnimations(GuidracoEntity entity, long id, AnimationState<GuidracoEntity> state) {
