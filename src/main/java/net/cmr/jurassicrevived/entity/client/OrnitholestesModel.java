...
public class OrnitholestesModel extends GeoModel<OrnitholestesEntity> {

    private static final Map<OrnitholestesVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(OrnitholestesVariant.class), map -> {
                map.put(OrnitholestesVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/ornitholestes.png"));
                map.put(OrnitholestesVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/ornitholestes_female.png"));
            });
    ...
    public ResourceLocation getModelResource(OrnitholestesEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/ornitholestes.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(OrnitholestesEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/ornitholestes.animation.json");
    }
    ...
    public void setCustomAnimations(OrnitholestesEntity entity, long id, AnimationState<OrnitholestesEntity> state) {
        ...
        String[] tailBones = { "TailBASE", "Tail2", "Tail3", "Tail4", "Tail5" };
