...
public class CorythosaurusModel extends GeoModel<CorythosaurusEntity> {
    ...
    private static final Map<CorythosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(CorythosaurusVariant.class), map -> {
                map.put(CorythosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/corythosaurus.png"));
                map.put(CorythosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/corythosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(CorythosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/corythosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(CorythosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/corythosaurus.animation.json");
    }
