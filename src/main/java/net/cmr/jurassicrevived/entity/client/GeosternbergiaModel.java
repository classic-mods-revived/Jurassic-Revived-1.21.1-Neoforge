...
public class GeosternbergiaModel extends GeoModel<GeosternbergiaEntity> {
    ...
    private static final Map<GeosternbergiaVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(GeosternbergiaVariant.class), map -> {
                map.put(GeosternbergiaVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/geosternbergia.png"));
                map.put(GeosternbergiaVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/geosternbergia_female.png"));
            });
    ...
    public ResourceLocation getModelResource(GeosternbergiaEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/geosternbergia.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(GeosternbergiaEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/geosternbergia.animation.json");
    }
