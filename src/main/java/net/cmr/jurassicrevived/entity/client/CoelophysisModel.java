...
public class CoelophysisModel extends GeoModel<CoelophysisEntity> {
    ...
    private static final Map<CoelophysisVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(CoelophysisVariant.class), map -> {
                map.put(CoelophysisVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/coelophysis.png"));
                map.put(CoelophysisVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/coelophysis_female.png"));
            });
    ...
    public ResourceLocation getModelResource(CoelophysisEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/coelophysis.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(CoelophysisEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/coelophysis.animation.json");
    }
