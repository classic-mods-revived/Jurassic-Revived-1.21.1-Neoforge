...
public class AnkylosaurusModel extends GeoModel<AnkylosaurusEntity> {
    ...
    private static final Map<AnkylosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(AnkylosaurusVariant.class), map -> {
                map.put(AnkylosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/ankylosaurus.png"));
                map.put(AnkylosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/ankylosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(AnkylosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/ankylosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(AnkylosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/ankylosaurus.animation.json");
    }
