...
public class PteranodonModel extends GeoModel<PteranodonEntity> {
    ...
    private static final Map<PteranodonVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(PteranodonVariant.class), map -> {
                map.put(PteranodonVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/pteranodon.png"));
                map.put(PteranodonVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/pteranodon_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(PteranodonEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/pteranodon.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(PteranodonEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(PteranodonEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/pteranodon.animation.json");
    }

    @Override
    public void setCustomAnimations(PteranodonEntity entity, long id, AnimationState<PteranodonEntity> state) {
