...
public class TitanosaurusModel extends GeoModel<TitanosaurusEntity> {

    private static final Map<TitanosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(TitanosaurusVariant.class), map -> {
                map.put(TitanosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/titanosaurus.png"));
                map.put(TitanosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/titanosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(TitanosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/titanosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(TitanosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/titanosaurus.animation.json");
    }
    ...
    public void setCustomAnimations(TitanosaurusEntity entity, long id, AnimationState<TitanosaurusEntity> state) {
        ...
        String[] tailBones = { "tail", "tail1", "tail2", "tail3", "tail4", "tail5", "tail6", "tail7" };
