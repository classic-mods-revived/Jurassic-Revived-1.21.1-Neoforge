...
public class AllosaurusModel extends GeoModel<AllosaurusEntity> {
    ...
    private static final Map<AllosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(AllosaurusVariant.class), map -> {
                map.put(AllosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/allosaurus.png"));
                map.put(AllosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/allosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(AllosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/allosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(AllosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/allosaurus.animation.json");
    }
