...
public class SegisaurusModel extends GeoModel<SegisaurusEntity> {
    ...
    private static final Map<SegisaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(SegisaurusVariant.class), map -> {
                map.put(SegisaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/segisaurus.png"));
                map.put(SegisaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/segisaurus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(SegisaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/segisaurus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(SegisaurusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(SegisaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/segisaurus.animation.json");
    }

    @Override
    public void setCustomAnimations(SegisaurusEntity entity, long id, AnimationState<SegisaurusEntity> state) {
