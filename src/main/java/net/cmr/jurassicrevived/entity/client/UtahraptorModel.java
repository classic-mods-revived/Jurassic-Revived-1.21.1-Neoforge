...
import net.cmr.jurassicrevived.entity.custom.UtahraptorEntity;
...
public class UtahraptorModel extends GeoModel<UtahraptorEntity> {
    ...
    private static final Map<UtahraptorVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(UtahraptorVariant.class), map -> {
                map.put(UtahraptorVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/utahraptor.png"));
                map.put(UtahraptorVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/utahraptor_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(UtahraptorEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/utahraptor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(UtahraptorEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(UtahraptorEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/utahraptor.animation.json");
    }

    @Override
    public void setCustomAnimations(UtahraptorEntity entity, long id, AnimationState<UtahraptorEntity> state) {
