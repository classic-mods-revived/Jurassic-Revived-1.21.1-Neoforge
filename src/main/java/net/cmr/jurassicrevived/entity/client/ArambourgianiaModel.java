...
public class ArambourgianiaModel extends GeoModel<ArambourgianiaEntity> {
    ...
    private static final Map<ArambourgianiaVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(ArambourgianiaVariant.class), map -> {
                map.put(ArambourgianiaVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/arambourgiania.png"));
                map.put(ArambourgianiaVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/arambourgiania_female.png"));
            });
    ...
    public ResourceLocation getModelResource(ArambourgianiaEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/arambourgiania.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(ArambourgianiaEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/arambourgiania.animation.json");
    }
