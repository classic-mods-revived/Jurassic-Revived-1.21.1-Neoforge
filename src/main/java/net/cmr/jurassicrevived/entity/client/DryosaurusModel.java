...
public class DryosaurusModel extends GeoModel<DryosaurusEntity> {
    ...
    private static final Map<DryosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(DryosaurusVariant.class), map -> {
                map.put(DryosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/dryosaurus.png"));
                map.put(DryosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/dryosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(DryosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/dryosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(DryosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/dryosaurus.animation.json");
    }
    ...
    public void setCustomAnimations(DryosaurusEntity entity, long id, AnimationState<DryosaurusEntity> state) {
        ...
        GeoBone head = getAnimationProcessor().getBone("Body4");
