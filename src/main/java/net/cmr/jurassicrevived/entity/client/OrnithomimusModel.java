...
public class OrnithomimusModel extends GeoModel<OrnithomimusEntity> {

    private static final Map<OrnithomimusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(OrnithomimusVariant.class), map -> {
                map.put(OrnithomimusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/ornithomimus.png"));
                map.put(OrnithomimusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/ornithomimus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(OrnithomimusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/ornithomimus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(OrnithomimusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(OrnithomimusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/ornithomimus.animation.json");
    }

    @Override
    public void setCustomAnimations(OrnithomimusEntity entity, long id, AnimationState<OrnithomimusEntity> state) {
