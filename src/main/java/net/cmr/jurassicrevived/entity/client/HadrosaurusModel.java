...
public class HadrosaurusModel extends GeoModel<HadrosaurusEntity> {

    private static final Map<HadrosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(HadrosaurusVariant.class), map -> {
                map.put(HadrosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/hadrosaurus.png"));
                map.put(HadrosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/hadrosaurus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(HadrosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/hadrosaurus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(HadrosaurusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(HadrosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/hadrosaurus.animation.json");
    }

    @Override
    public void setCustomAnimations(HadrosaurusEntity entity, long id, AnimationState<HadrosaurusEntity> state) {
