...
public class PterodaustroModel extends GeoModel<PterodaustroEntity> {
    ...
    private static final Map<PterodaustroVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(PterodaustroVariant.class), map -> {
                map.put(PterodaustroVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/pterodaustro.png"));
                map.put(PterodaustroVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/pterodaustro_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(PterodaustroEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/pterodaustro.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(PterodaustroEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(PterodaustroEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/pterodaustro.animation.json");
    }

    @Override
    public void setCustomAnimations(PterodaustroEntity entity, long id, AnimationState<PterodaustroEntity> state) {
