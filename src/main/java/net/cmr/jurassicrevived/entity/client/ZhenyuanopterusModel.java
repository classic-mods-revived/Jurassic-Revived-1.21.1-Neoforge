...
public class ZhenyuanopterusModel extends GeoModel<ZhenyuanopterusEntity> {

    private static final Map<ZhenyuanopterusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(ZhenyuanopterusVariant.class), map -> {
                map.put(ZhenyuanopterusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/zhenyuanopterus.png"));
                map.put(ZhenyuanopterusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/zhenyuanopterus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(ZhenyuanopterusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/zhenyuanopterus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(ZhenyuanopterusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(ZhenyuanopterusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/zhenyuanopterus.animation.json");
    }

    @Override
    public void setCustomAnimations(ZhenyuanopterusEntity entity, long id, AnimationState<ZhenyuanopterusEntity> state) {
