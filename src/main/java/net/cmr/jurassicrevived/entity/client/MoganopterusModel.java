...
public class MoganopterusModel extends GeoModel<MoganopterusEntity> {

    private static final Map<MoganopterusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(MoganopterusVariant.class), map -> {
                map.put(MoganopterusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/moganopterus.png"));
                map.put(MoganopterusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/moganopterus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(MoganopterusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/moganopterus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(MoganopterusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(MoganopterusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/moganopterus.animation.json");
    }

    @Override
    public void setCustomAnimations(MoganopterusEntity entity, long id, AnimationState<MoganopterusEntity> state) {
