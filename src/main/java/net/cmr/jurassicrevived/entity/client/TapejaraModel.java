...
import net.cmr.jurassicrevived.entity.custom.TapejaraEntity;
...
public class TapejaraModel extends GeoModel<TapejaraEntity> {
    ...
    private static final Map<TapejaraVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(TapejaraVariant.class), map -> {
                map.put(TapejaraVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/tapejara.png"));
                map.put(TapejaraVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/tapejara_female.png"));
            });
    ...
    public ResourceLocation getModelResource(TapejaraEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/tapejara.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(TapejaraEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/tapejara.animation.json");
    }

    @Override
    public void setCustomAnimations(TapejaraEntity entity, long id, AnimationState<TapejaraEntity> state) {
