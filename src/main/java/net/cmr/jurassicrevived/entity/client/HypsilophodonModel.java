...
public class HypsilophodonModel extends GeoModel<HypsilophodonEntity> {

    private static final Map<HypsilophodonVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(HypsilophodonVariant.class), map -> {
                map.put(HypsilophodonVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/hypsilophodon.png"));
                map.put(HypsilophodonVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/hypsilophodon_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(HypsilophodonEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/hypsilophodon.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(HypsilophodonEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(HypsilophodonEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/hypsilophodon.animation.json");
    }

    @Override
    public void setCustomAnimations(HypsilophodonEntity entity, long id, AnimationState<HypsilophodonEntity> state) {
