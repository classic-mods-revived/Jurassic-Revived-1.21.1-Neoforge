...
public class TroodonModel extends GeoModel<TroodonEntity> {
    ...
    private static final Map<TroodonVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(TroodonVariant.class), map -> {
                map.put(TroodonVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/troodon.png"));
                map.put(TroodonVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/troodon_female.png"));
            });
    ...
    public ResourceLocation getModelResource(TroodonEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/troodon.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(TroodonEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/troodon.animation.json");
    }

    @Override
    public void setCustomAnimations(TroodonEntity entity, long id, AnimationState<TroodonEntity> state) {
        super.setCustomAnimations(entity, id, state);

        String[] tailBones = { "Tailstart", "Tail1", "Tail2", "Tail3", "Tail4", "Tail5" };
