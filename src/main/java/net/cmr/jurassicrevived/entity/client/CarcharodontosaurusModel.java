...
public class CarcharodontosaurusModel extends GeoModel<CarcharodontosaurusEntity> {
    ...
    private static final Map<CarcharodontosaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(CarcharodontosaurusVariant.class), map -> {
                map.put(CarcharodontosaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/carcharodontosaurus.png"));
                map.put(CarcharodontosaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/carcharodontosaurus_female.png"));
            });
    ...
    public ResourceLocation getModelResource(CarcharodontosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/carcharodontosaurus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(CarcharodontosaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/carcharodontosaurus.animation.json");
    }
