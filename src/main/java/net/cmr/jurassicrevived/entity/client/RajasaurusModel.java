...
import net.cmr.jurassicrevived.entity.custom.RajasaurusEntity;
...
public class RajasaurusModel extends GeoModel<RajasaurusEntity> {

    private static final Map<RajasaurusVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(RajasaurusVariant.class), map -> {
                map.put(RajasaurusVariant.MALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/rajasaurus.png"));
                map.put(RajasaurusVariant.FEMALE, ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "textures/entity/rajasaurus_female.png"));
            });
    ...
    @Override
    public ResourceLocation getModelResource(RajasaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "geo/rajasaurus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(RajasaurusEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }

    @Override
    public ResourceLocation getAnimationResource(RajasaurusEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(JRMod.MOD_ID, "animations/rajasaurus.animation.json");
    }

    @Override
    public void setCustomAnimations(RajasaurusEntity entity, long id, AnimationState<RajasaurusEntity> state) {
        ...
        GeoBone head = getAnimationProcessor().getBone("NeckBASE");
