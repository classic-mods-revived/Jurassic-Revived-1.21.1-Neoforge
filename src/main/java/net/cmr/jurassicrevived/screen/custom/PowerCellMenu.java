...
public class PowerCellMenu extends AbstractContainerMenu {
    ...
    public PowerCellMenu(int pContainerId, Inventory inv, BlockEntity blockEntity) {
        super(ModMenuTypes.POWER_CELL_MENU.get(), pContainerId);
        checkContainerSize(inv, 2);
        this.blockEntity = ((PowerCellBlockEntity) blockEntity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.POWER_CELL.get());
    }
